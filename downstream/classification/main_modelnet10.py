...
from data import ModelNet40, ModelNet40Subset, ModelNet10Dataset
...
def train(args, io):
    ...
    train_dataset = ModelNet10Dataset(root_dir='data/ModelNet10', split='train')
    test_dataset = ModelNet10Dataset(root_dir='data/ModelNet10', split='test')
